  ...
  return (
   ...
   <div className="container fairpersonal__container">
      ...
      <h2>Find Fair Personal Loans for Bad Credit</h2>
       ...
       Learn more about the ins and outs of pPoor Credit Quick Loans, or submit a request for a personal loan right now, so you don’t have to put your life on hold.
