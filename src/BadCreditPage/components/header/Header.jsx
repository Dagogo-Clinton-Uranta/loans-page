...
const Header = () => {
  ...
  return (
    ...
    <div className="container header__container-1">
      ...
      <h1>How to Get a Loan with Bad Credit</h1>

         <p>
         Life happens and mistakes can negatively impact your credit score for years.Our guide can help people with bad credit get a loan.
     ...
     <div className='CTAbox'>
       <h4>Start your bad credit loan request</h4>
     ...
     {  <div className='sliderLabel' style={{marginLeft:`${(input*100/3500)*16/20}%`}}>${input.toLocaleString()}</div>}
       <input
        ...
        max={3500}
        step={100}
        value={input.toLocaleString("en-US")}
