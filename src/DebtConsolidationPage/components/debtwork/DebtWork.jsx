...
const DebtWork = () => {
  return (
    ...
    <div className="container personal__header__container">
      ...
      <div className="personal__headerdebtwork">
      

        
        <h3>Does Debt Consolidation Work? </h3>
...
<h4>Pros</h4>
<ul>
<li>  You can save a lot of money with lower payments and lower interest rates.</li>
<li>Monthly payments force you to stay on a schedule for paying down debt.</li>
